...
// ListenAndServe 启动服务
// 这一层是整体服务的启动，内部包裹了raftServer
// raftServer是raft算法的核心实现，本服务启动了http监听和raftServer
// http监听为raftServer提供必要的网络支持
